...
#        e.q.
#          a. python convert_to_mnist_format.py TS test 0
#          b. python convert_to_mnist_format.py notMNIST_small test
#          c. python convert_to_mnist_format.py TR train 0
#          d. python convert_to_mnist_format.py notMNIST_small train

#
#  Run this command in CMD
# `python convert_to_mnist_format.py TR train 0
#  python convert_to_mnist_format.py TS test 0
